...
export const WhatsAppConnect: React.FC = () => {
  ...
  return (
    <div className="p-3 sm:p-6 lg:p-8 max-w-5xl mx-auto space-y-4 sm:space-y-6 overflow-y-auto h-full">
      {/* Header */}
      <div>
