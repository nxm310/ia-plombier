 ...
 */
export async function getAvailableSlots(teamMemberId, date, // YYYY-MM-DD
durationMinutes = 30) {
 ...
 */
export async function findMembersBySpecialty(specialtyOrKeyword) {
 ...
 */
export async function isSlotAvailable(teamMemberId, date, startTime, endTime) {
